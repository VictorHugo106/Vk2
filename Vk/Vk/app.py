...
from modules.Doadores.Doadores import bp_Doadores
app.register_blueprint(bp_Doadores, url_prefix='/Doadores')

from modules.Doacoess.Doacoess import bp_Doacoes
app.register_blueprint(bp_Doacoes, url_prefix='/Doacoess')
